<template>
  <div class="dashboard-container">
    <el-button id="myPrint" v-print="myPrint">打印</el-button>
...
<script>
import { getbasicInformation as getPersonalDetail,
  getWorkInfo as getJobDetail } from '@/api/employ'
import { getUserdetailsAPI as getUserDetailById } from '@/api/user'
export default {
  data() {
    return {
      formData: {},
